...
private fun cloneHelper(
    ...
    replacements(node) ?: with(node) {
        ...
        when (this) {
            ...
            is AugmentedExpression.AddZero -> AugmentedExpression.AddZero(originalExpression.clone(replacements), zeroExpression.clone(replacements), zeroOnLeft)
            ...
            is AugmentedExpression.MulOne -> AugmentedExpression.MulOne(originalExpression.clone(replacements), oneExpression.clone(replacements), oneOnLeft)
